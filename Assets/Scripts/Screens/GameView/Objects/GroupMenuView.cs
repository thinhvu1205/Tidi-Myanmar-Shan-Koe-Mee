...
public class GroupMenuView : BaseView
{
    ...
    protected override void Start()
    {
        ...
        if (curGameId == (int)Globals.GAMEID.SLOT20FRUIT ||
         curGameId == (int)Globals.GAMEID.SLOTNOEL ||
         (curGameId == (int)Globals.GAMEID.SLOTTARZAN) ||
          (curGameId == (int)Globals.GAMEID.SLOT_JUICY_GARDEN) ||
          (curGameId == (int)Globals.GAMEID.SLOT_SIXIANG) ||
          (curGameId == (int)Globals.GAMEID.SLOT_INCA))
        {
            btnChangeTable.gameObject.SetActive(false);
        }
        if ((curGameId == (int)Globals.GAMEID.DRAGONTIGER) || (curGameId == (int)Globals.GAMEID.BAUCUA) || (curGameId == (int)Globals.GAMEID.SESKU)) btnRule.gameObject.SetActive(false);
